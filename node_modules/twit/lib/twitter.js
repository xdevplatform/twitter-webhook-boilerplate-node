...
Twitter.prototype.del = function (path, params, callback) {
  return this.request('DEL', path, params, callback)
}

Twitter.prototype.request = function (method, path, params, callback) {
  var self = this;
  assert(method == 'GET' || method == 'POST' || method == 'DEL');
 ...
 * @param  {String}   method      "GET" or "POST" or "DEL"
